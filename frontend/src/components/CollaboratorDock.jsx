...
export default function CollaboratorDock({ activeUsers = [], typingUsers = [] }) {
  ...
  return (
    <div ref={dockRef} className="fixed bottom-12 sm:bottom-14 right-3 sm:right-6 z-30 select-none">
      <div className="relative flex flex-col items-end gap-2">
        {/* Floating Collaborators List Popover */}
        {isOpen && (
          <div className="w-[calc(100vw-24px)] max-w-[280px] sm:max-w-[300px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl p-3 mb-1 animate-in fade-in zoom-in-95">
        ...
        {/* Typing indicators above pill */}
        {typingUsers.length > 0 && !isOpen && (
