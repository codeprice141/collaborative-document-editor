    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
      ...
      <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1.5rem" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
          <div>
            <h1 style={{ fontSize: "1.75rem", fontWeight: "700", color: "#0f172a" }}>My Documents</h1>
            <p style={{ fontSize: "0.875rem", color: "#64748b", marginTop: "0.25rem" }}>Create, share and collaborate in real time</p>
          </div>
        ...
        <div style={{ position: "relative", marginBottom: "1.5rem", maxWidth: "400px" }}>
          ...
          <input
            ...
            style={{ width: "100%", padding: "0.6rem 0.75rem 0.6rem 2.25rem", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "0.875rem" }}
          />
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "4rem 1rem", backgroundColor: "#ffffff", borderRadius: "12px", border: "1px dashed #cbd5e1" }}>
            ...
            <p style={{ fontSize: "0.875rem", color: "#64748b", marginTop: "0.25rem" }}>Click 'New Document' to start writing.</p>
          </div>
        ) : (
              ...
              >
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.75rem" }}>
                    ...
                    <span style={{
                      fontSize: "0.75rem", padding: "0.2rem 0.5rem", borderRadius: "9999px", fontWeight: "600",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "0.75rem", borderTop: "1px solid #f1f5f9", marginTop: "1rem", fontSize: "0.75rem", color: "#94a3b8" }}>
